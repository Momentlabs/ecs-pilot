...
export const fail = colors.red600;
export const warn = colors.aber200;
export const success = colors.green400;

export const resourceUsed = colors.blue500;
export const resourceOk =  colors.teal500;
export const resourceWarn = colors.amber500;
